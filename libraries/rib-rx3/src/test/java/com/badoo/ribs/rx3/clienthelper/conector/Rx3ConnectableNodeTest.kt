package com.badoo.ribs.rx3.clienthelper.conector

import com.badoo.ribs.core.Node
import com.badoo.ribs.core.plugin.SubtreeChangeAware
import com.badoo.ribs.rx3.clienthelper.conector.helpers.Rx3ConnectableTestNode
import com.badoo.ribs.rx3.clienthelper.conector.helpers.Rx3ConnectableTestRib.Output
import com.badoo.ribs.rx3.clienthelper.conector.helpers.Rx3ConnectableTestRib.Output.Output1
import com.badoo.ribs.rx3.clienthelper.conector.helpers.Rx3ConnectableTestRib.Output.Output2
...
class Rx3ConnectableNodeTest : BaseConnectableNodeTest() {

    private lateinit var parent: Rx3ConnectableTestNode
    ...
    private val changesAwarePlugin = object : SubtreeChangeAware {
        override fun onChildAttached(child: Node<*>) {
            (child as Rx3ConnectableTestNode).output.subscribe {
    ...
    @BeforeEach
    fun setUp() {
        parent = Rx3ConnectableTestNode(plugins = listOf(changesAwarePlugin))
    }
    ...
    override fun `WHEN_child_emit_some_output_before_it_is_attached_to_parent_THEN_parent_receive_the_output_after_child_attach_finished`() {
        val children = Rx3ConnectableTestNode(parent = parent)
