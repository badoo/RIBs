package com.badoo.ribs.samples.gallery.rib.routing_picker
...
private fun View(
    ...
    Box(
        ...
        Column(modifier = Modifier.width(IntrinsicSize.Min)) {
            Button(
                onClick = { events.accept(Event.SimpleRoutingClicked) },
                modifier = buttonModifier
            ) {
                Text("Simple static routing")
            }
            Button(
                onClick = { events.accept(Event.BackStackClicked) },
                modifier = buttonModifier
            ) {
                Text("Back stack")
            }
            Button(
                onClick = { events.accept(Event.TransitionsClicked) },
                modifier = buttonModifier
            ) {
