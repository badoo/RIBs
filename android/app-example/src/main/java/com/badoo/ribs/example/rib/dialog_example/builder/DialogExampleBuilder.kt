...
) : SimpleBuilder<Node<DialogExampleView>>(object : DialogExample {}) {

    private val dependency : DialogExample.Dependency = object : DialogExample.Dependency by dependency {
