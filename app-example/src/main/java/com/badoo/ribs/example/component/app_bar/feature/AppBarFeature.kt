package com.badoo.ribs.example.component.app_bar.feature
...
import com.badoo.ribs.example.component.app_bar.feature.AppBarFeature.Effect
...
internal class AppBarFeature : ActorReducerFeature<Wish, Effect, State, News>(
    initialState = State(),
